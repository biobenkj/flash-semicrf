...
def _compute_checkpoint_interval(T: int, K: int) -> int:
    r"""Compute optimal checkpoint interval to minimize total memory.
...
def compute_edge_block_golden_rule(
    ...
    r"""Compute edge block on-the-fly using the Golden Rule.
    ...
    Returns:
        Edge potentials of shape (batch, C, C).
    """
...
def semi_crf_streaming_forward_pytorch(
    ...
    r"""Forward pass with Golden Rule edge computation.
    ...
    Args:
        ...
        proj_start: Start boundary scores of shape (batch, T, C). Optional.
        proj_end: End boundary scores of shape (batch, T, C). Optional.
        checkpoint_interval: Interval for saving ring buffer state. Optional.

    Returns:
        Tuple of (partition, ring_checkpoints, checkpoint_interval).
    """
...
def semi_crf_streaming_backward_pytorch(
    ...
    r"""Backward pass computing gradients via marginals.
    ...
    Args:
        ...
        ring_checkpoints: Saved ring buffer states.
        checkpoint_interval: Interval between checkpoints.
        semiring: "log" or "max".
        proj_start: Start boundary scores. Optional.
        proj_end: End boundary scores. Optional.

    Returns:
        Tuple of gradients: (grad_cum_scores, grad_transition, grad_duration_bias,
